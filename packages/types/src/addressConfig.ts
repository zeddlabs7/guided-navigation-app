...
export const ADDRESS_TYPE_STEP_CONFIG: Record<AddressType, AddressTypeConfig> = {
  APARTMENT_BUILDING: {
    stepTypes: [
      { type: 'PARKING_LOCATION', orderHint: 'Usually 1st', orderIndex: 1 },
      { type: 'BUILDING_ENTRY', orderHint: 'Usually 2nd', orderIndex: 2 },
      { type: 'RECEPTION_OR_SECURITY', orderHint: 'Usually 3rd', orderIndex: 3 },
      { type: 'LOBBY_NAVIGATION', orderHint: 'Usually 4th', orderIndex: 4 },
      { type: 'ELEVATOR_ENTRY', orderHint: 'Usually 5th', orderIndex: 5 },
      { type: 'STAIRS_ENTRY', orderHint: 'Alternative to elevator', orderIndex: 5 },
      { type: 'FLOOR_NUMBER', orderHint: 'Usually 6th', orderIndex: 6 },
      { type: 'CORRIDOR_OR_PATH', orderHint: 'Usually 7th', orderIndex: 7 },
      { type: 'DOOR_IDENTIFICATION', orderHint: 'Usually 8th', orderIndex: 8 },
      { type: 'DROP_OFF_POINT', orderHint: 'Usually last', orderIndex: 9 },
  ...
  VILLA: {
    stepTypes: [
      { type: 'GATE_ENTRY', orderHint: 'Usually 1st', orderIndex: 1 },
      { type: 'PARKING_LOCATION', orderHint: 'Usually 2nd', orderIndex: 2 },
      { type: 'UNIT_OR_DOOR_IDENTIFICATION', orderHint: 'Usually 3rd', orderIndex: 3 },
  ...
  RESIDENTIAL_COMPOUND: {
    stepTypes: [
      { type: 'PARKING_LOCATION', orderHint: 'Usually 1st', orderIndex: 1 },
      { type: 'GATE_ENTRY', orderHint: 'Usually 2nd', orderIndex: 2 },
      { type: 'RECEPTION_OR_SECURITY', orderHint: 'Usually 3rd', orderIndex: 3 },
      { type: 'CORRIDOR_OR_PATH', orderHint: 'Usually 4th', orderIndex: 4 },
      { type: 'BUILDING_ENTRY', orderHint: 'Usually 5th', orderIndex: 5 },
      { type: 'FLOOR_NAVIGATION', orderHint: 'Usually 6th', orderIndex: 6 },
      { type: 'UNIT_OR_DOOR_IDENTIFICATION', orderHint: 'Usually 7th', orderIndex: 7 },
      { type: 'DROP_OFF_POINT', orderHint: 'Usually last', orderIndex: 8 },
      { type: 'OTHER', orderHint: 'Anytime', orderIndex: 99 },
    ],
    requiresMetadata: true,
  ...
  OFFICE_BUILDING: {
    stepTypes: [
      { type: 'PARKING_LOCATION', orderHint: 'Usually 1st', orderIndex: 1 },
      { type: 'GATE_ENTRY', orderHint: 'Usually 2nd', orderIndex: 2 },
      { type: 'BUILDING_ENTRY', orderHint: 'Usually 3rd', orderIndex: 3 },
      { type: 'RECEPTION_OR_SECURITY', orderHint: 'Usually 4th', orderIndex: 4 },
      { type: 'LOBBY_NAVIGATION', orderHint: 'Usually 5th', orderIndex: 5 },
      { type: 'ELEVATOR_ENTRY', orderHint: 'Usually 6th', orderIndex: 6 },
      { type: 'FLOOR_NUMBER', orderHint: 'Usually 7th', orderIndex: 7 },
      { type: 'CORRIDOR_OR_PATH', orderHint: 'Usually 8th', orderIndex: 8 },
    ...
    requiresMetadata: true,
    metadataFields: ['buildingNumber', 'floorNumber'],
    metadataFieldConfigs: [
      {
        field: 'buildingNumber',
        label: { en: 'Building Name', ar: 'اسم المبنى', hi: 'भवन का नाम', ur: 'عمارت کا نام', bn: 'ভবনের নাম' },
        placeholder: { en: 'e.g. Al Nakheel Tower, King Fahd Center', ar: 'مثال: برج النخيل، مركز الملك فهد', hi: 'e.g. Al Nakheel Tower, King Fahd Center', ur: 'e.g. Al Nakheel Tower, King Fahd Center', bn: 'e.g. Al Nakheel Tower, King Fahd Center' },
        required: true,
      },
      {
        field: 'floorNumber',
        label: { en: 'Drop-off location inside the building', ar: 'موقع التسليم داخل المبنى', hi: 'भवन के अंदर ड्रॉप-ऑफ स्थान', ur: 'عمارت کے اندر ڈراپ آف مقام', bn: 'ভবনের ভিতরে ড্রপ-অফ অবস্থান' },
        placeholder: { en: 'e.g. Reception, Office 501, Room 3B', ar: 'مثال: الاستقبال، مكتب 501، غرفة 3ب', hi: 'e.g. Reception, Office 501, Room 3B', ur: 'e.g. Reception, Office 501, Room 3B', bn: 'e.g. Reception, Office 501, Room 3B' },
        required: true,
      },
    ],
  ...
  OTHER: {
    stepTypes: [
      { type: 'PARKING_LOCATION', orderHint: 'Usually 1st', orderIndex: 1 },
      { type: 'DROP_OFF_POINT', orderHint: 'Usually last', orderIndex: 2 },
      { type: 'OTHER', orderHint: 'Anytime', orderIndex: 99 },
    ],
    requiresMetadata: true,
